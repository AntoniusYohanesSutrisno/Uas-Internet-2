...
<body>
    <nav>
        <div class="wrapper">
            <div class="logo"><a href="">HARUN KOMPUTER</a></div>
            <div class="menu">
                <ul>
                    <li><a href="index.php#home">MENU UTAMA</a></li>
                    <li><a href="index.php#jenisjasa">Layanan Jasa Kami</a></li>
                    <li><a href="jasa.php">Pesan Jasa</a></li>
                    <li><a href="index.php#bantuan">Bantuan</a></li>
                    <li><a href="index.php#contact">Contact Person</a></li>
                    <!-- Kalau sudah login -->
